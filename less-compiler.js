...
less.render(`${basicStyles}`, {
  ...
  const before = '.ant-layout-header{height:64px;padding:0 50px;color:rgba(0,0,0,.85);line-height:64px;background:#001529}';
  const after = '.ant-layout-header{height:64px;padding:0 50px;color:rgba(0,0,0,.85);line-height:64px;background:#ffffff}';
  data.css = data.css.replace(before, after);
